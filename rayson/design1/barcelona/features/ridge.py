    ...
    for alpha in alpha_values:
        ...
        if len(extracted_features_idx) != 0:
            ...
            for lambda_value in lambda_values:
                ...
                save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/barcelona/features/results/results-a-{a_value:.2f}-alpha-{alpha}-lambda-{lambda_value}.txt", results)
                
                # Save confusion matrix (2D array)
                save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/barcelona/features/results/conf_matrix-a-{a_value:.2f}-alpha-{alpha}-lambda-{lambda_value}.txt", conf_matrix)