...
if __name__ == "__main__":
    ...
    results, conf_matrix, weights = ridge_regression(X_train, y_train, X_val, y_val, lambda_value, a_value, u_dc_value)

    # Save weights
    save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/barcelona/features/validation/weights/weights-a-{a_value:.2f}-lambda-{lambda_value}.txt", weights)