...
if __name__ == "__main__":
    ...
    # Load the weights
    weights = np.loadtxt(f"/scratch/almo2783/scratch/rayson/design1/barcelona/features/validation/weights/weights-a--1.08-lambda-10000.0.txt")
    ...
    for alpha in alpha_values:
        ...
        if len(extracted_features_idx) != 0:
            ...
            for lambda_value in lambda_values:
                ...
                results, conf_matrix = ridge_regression(X_train_selected, y_train, X_val_selected, y_val, lambda_value, a_value, u_dc_value)
                ...
                save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/barcelona/features/validation/results/results-a-{a_value:.2f}-alpha-{alpha}-lambda-{lambda_value}.txt", results)
                
                # Save confusion matrix (2D array)
                save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/barcelona/features/validation/results/conf_matrix-a-{a_value:.2f}-alpha-{alpha}-lambda-{lambda_value}.txt", conf_matrix)