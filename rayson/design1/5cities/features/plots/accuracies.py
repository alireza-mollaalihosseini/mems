...
feature_lengths = {
    1e-6: {1: 23812, 2: 19162, 3: 9342, 4: 3350, 5: 1430, 6: 824, 7: 581, 8: 436, 9: 348, 10: 295, 15: 151, 20: 77, 50: 5}
}
...
for idx, alpha in enumerate(alpha_values):
    ...
    for lambda_value in lambda_values:
        try:
            # Load the data
            data = np.loadtxt(f"/scratch/almo2783/scratch/rayson/design1/5cities/features/results/results-a-{a_value:.2f}-alpha-{alpha}-lambda-{lambda_value}.txt")
            test_accuracy = data[4] * 100
            accuracies.append(test_accuracy)
        except Exception as e:
            accuracies.append(np.nan)
