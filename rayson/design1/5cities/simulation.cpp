...
int main(int argc, char *argv[]) {
    ...
    std::string X_train = "/scratch/almo2783/scratch/rayson/design1/5cities/state-matrices/X_train_a_" + ss.str() + "_u_dc_" + su.str() + ".txt";
    std::string y_train = "/scratch/almo2783/scratch/rayson/design1/5cities/state-matrices/y_train_a_" + ss.str() + "_u_dc_" + su.str() + ".txt";
    std::string X_val   = "/scratch/almo2783/scratch/rayson/design1/5cities/state-matrices/X_val_a_" + ss.str() + "_u_dc_" + su.str() + ".txt";
    std::string y_val   = "/scratch/almo2783/scratch/rayson/design1/5cities/state-matrices/y_val_a_" + ss.str() + "_u_dc_" + su.str() + ".txt";
    std::string X_test  = "/scratch/almo2783/scratch/rayson/design1/5cities/state-matrices/X_test_a_" + ss.str() + "_u_dc_" + su.str() + ".txt";
    std::string y_test  = "/scratch/almo2783/scratch/rayson/design1/5cities/state-matrices/y_test_a_" + ss.str() + "_u_dc_" + su.str() + ".txt";

    // Process the dataset
    processDataset("/scratch/almo2783/scratch/rayson/design1/5cities/train-filenames-5cities-rayson.csv", X_train, y_train,
                   a, u_dc, h, Nodes, t0, y0, t_end, k, omega_0, Q_0, alpha, beta, gamma, R, tau, u_max, t_ext, mu);

    processDataset("//scratch/almo2783/scratch/rayson/design1/5cities/val-filenames-5cities-rayson.csv", X_val, y_val,
                   a, u_dc, h, Nodes, t0, y0, t_end, k, omega_0, Q_0, alpha, beta, gamma, R, tau, u_max, t_ext, mu);

    processDataset("/scratch/almo2783/scratch/rayson/design1/5cities/test-filenames-barcelona-rayson.csv", X_test, y_test,
                   a, u_dc, h, Nodes, t0, y0, t_end, k, omega_0, Q_0, alpha, beta, gamma, R, tau, u_max, t_ext, mu);
