...
if __name__ == "__main__":
    ...
    save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/5cities/results/results-a-{a_value:.2f}-u_dc-{u_dc_value:.1f}.txt", results)
    
    # Save confusion matrix (2D array)
    save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/5cities/results/conf_matrix-a-{a_value:.2f}-u_dc-{u_dc_value:.1f}.txt", conf_matrix_val)
    ...
    # Save the results (scalars)
    save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/5cities/results/results-a-{a_value:.2f}-u_dc-{u_dc_value:.1f}-test.txt", test_results)
    
    # Save confusion matrix (2D array)
    save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/5cities/results/conf_matrix-a-{a_value:.2f}-u_dc-{u_dc_value:.1f}-test.txt", conf_matrix_test)