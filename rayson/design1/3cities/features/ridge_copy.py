...
if __name__ == "__main__":
    ...
    # lambda_value = 1e4
    alpha_values = [6]
    lambda_values = [1, 10, 100, 1e3, 1e4, 1e5]
    ...
    # Load the weights
    weights = np.loadtxt(f"/scratch/almo2783/scratch/rayson/design1/3cities/features/weights/weights-a--1.08-lambda-10000.0.txt")
    ...
    for alpha in alpha_values:
        ...
        if len(extracted_features_idx) != 0:
            ...
            for lambda_value in lambda_values:
                ...
                save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/features/results/results-a-{a_value:.2f}-alpha-{alpha}-lambda-{lambda_value}.txt", results)
                
                # Save confusion matrix (2D array)
                save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/features/results/conf_matrix-a-{a_value:.2f}-alpha-{alpha}-lambda-{lambda_value}.txt", conf_matrix)