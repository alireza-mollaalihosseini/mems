...
def ridge_regression(s_train_data, train_vectors, s_test_data, test_vectors, lam, a, u_dc):
    ...
    return results, conf_matrix, weights
...
if __name__ == "__main__":
    ...
    results, conf_matrix, weights = ridge_regression(X_train, y_train, X_test, y_test, lambda_value, a_value, u_dc_value)

    # Save weights
    save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/features/weights/weights-a-{a_value:.2f}-lambda-{lambda_value}.txt", weights)