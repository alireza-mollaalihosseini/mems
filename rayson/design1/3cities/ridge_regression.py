...
if __name__ == "__main__":
    ...
    X_train = load_matrix_from_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/state-matrices/X_train_a_{a_value:.2f}_u_dc_{u_dc_value:.1f}.txt")
    X_val   = load_matrix_from_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/state-matrices/X_val_a_{a_value:.2f}_u_dc_{u_dc_value:.1f}.txt")
    X_test  = load_matrix_from_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/state-matrices/X_test_a_{a_value:.2f}_u_dc_{u_dc_value:.1f}.txt")
    y_train = load_matrix_from_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/state-matrices/y_train_a_{a_value:.2f}_u_dc_{u_dc_value:.1f}.txt")
    y_val   = load_matrix_from_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/state-matrices/y_val_a_{a_value:.2f}_u_dc_{u_dc_value:.1f}.txt")
    y_test  = load_matrix_from_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/state-matrices/y_test_a_{a_value:.2f}_u_dc_{u_dc_value:.1f}.txt")
    ...
    save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/results/results-a-{a_value:.2f}-u_dc-{u_dc_value:.1f}.txt", results)
    
    # Save confusion matrix (2D array)
    save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/results/conf_matrix-a-{a_value:.2f}-u_dc-{u_dc_value:.1f}.txt", conf_matrix_val)
    ...
    # Evaluate on the test dataset using the same model
    ...
    # Save the results (scalars)
    save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/results/results-a-{a_value:.2f}-u_dc-{u_dc_value:.1f}-test.txt", test_results)
    
    # Save confusion matrix (2D array)
    save_matrix_to_file(f"/scratch/almo2783/scratch/rayson/design1/3cities/results/conf_matrix-a-{a_value:.2f}-u_dc-{u_dc_value:.1f}-test.txt", conf_matrix_test)