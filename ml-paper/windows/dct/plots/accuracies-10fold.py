...
n_folds = 10
results_dir = "/scratch/almo2783/scratch/ml-paper/windows/dct/results"
...
for lam in lambda_values:
    ...
    for fold in range(1, n_folds + 1):
        ...
        fpath = f"{results_dir}/fold_results-a-{a:.2f}-lambda-{lam:.1e}-fold-{fold}-win-{int(n_windows)}.txt"
...
plt.savefig(f"lambda-optimization-10folds-errorbars-win-{int(n_windows)}.png", dpi=300)
plt.close()
