...
# save the values
np.save("best_train_over_lam.npy",best_train_lam)
np.save("best_train_std.npy",best_train_std)
np.save("best_test_over_lam.npy",best_test_lam)
np.save("best_test_std.npy",best_test_std)
np.save("best_lambda_over_lam.npy",best_lambda_lam)
...
plt.savefig("lambda-optimization-10folds-errorbars-with-best-lambdas.png", dpi=300)
plt.close()
