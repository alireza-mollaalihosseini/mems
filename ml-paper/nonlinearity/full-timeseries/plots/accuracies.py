...
for lam in lambda_values:
    # Load test accuracy    /scratch/almo2783/scratch/ml-paper/nonlinearity/full-timeseries/results/result-a-0.44-u_0.4-lam-1.0e-01-win-10.npz
    data = np.load(f"/scratch/almo2783/scratch/ml-paper/nonlinearity/full-timeseries/results/result-a-0.44-u_0.4-lam-{lam:.1e}-win-10.npz")
    result = data["metrics"]
