...
# n_folds = 10
# results_dir = "/scratch/almo2783/scratch/ml-paper/nonlinearity/results-10fold"
...
#             fpath = f"{results_dir}/fold_results-a-{a}-lambda-{lam:.1e}-fold-{fold}.txt"
...
# best_train_a  = nap.array(best_train_a)
# best_test_a   = nap.array(best_test_a)
# best_lambda_a = nap.array(best_lambda_a)
...
# plt.savefig("feedback-optimization-10folds-errorbars.png", dpi=300)
# plt.close()
...
# save the values
np.save("best_train_over_a.npy",best_train_a)
np.save("best_train_std.npy",best_train_std)
np.save("best_test_over_a.npy",best_test_a)
np.save("best_test_std.npy",best_test_std)
np.save("best_lambda_over_a.npy",best_lambda_a)
