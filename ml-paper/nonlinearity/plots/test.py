...
if __name__ == "__main__":
    ...
    np.save(f"correlations.npy", correlations)
    ...
    plt.figure(figsize=(10, 6))
    plt.plot(a_values, correlations, marker="o", linewidth=2, label='correlation')
    ...
    if save_dir:
        ...
        save_path = os.path.join(save_dir, f"correlation_accuracy_vs_a_udc_{u_dc}.png")
        plt.savefig(save_path, dpi=300)
        print(f"✅ Plot saved: {save_path}")
