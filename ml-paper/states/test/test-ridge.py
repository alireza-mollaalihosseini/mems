...
if __name__ == "__main__":
    ...
    state_matrix_train = np.load("//scratch/almo2783/scratch/ml-paper/states/state-matrix/state_matrix_train-time-with-diff.npz")["arr_0"]
    state_matrix_val   = np.load("//scratch/almo2783/scratch/ml-paper/states/state-matrix/state_matrix_val-time-with-diff.npz")["arr_0"]
    state_matrix_test  = np.load("//scratch/almo2783/scratch/ml-paper/states/state-matrix/state_matrix_test-time-with-diff.npz")["arr_0"]
    state_matrix = np.concatenate([state_matrix_train, state_matrix_val, state_matrix_test])
    ...
    # Results dir
    results_dir = f"/scratch/almo2783/scratch/ml-paper/states/test"
