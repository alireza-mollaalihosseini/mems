...
# a = 0.44
a = -1.5
results_dir = "/scratch/almo2783/scratch/ml-paper/wavelet-packet/sensor-classification/results"
...
for lam in lambda_values:
    ...
    for fold in range(1, n_folds + 1):
        ...
        fpath = f"{results_dir}/fold_results-a-{a:.2f}-lambda-{lam:.1e}-fold-{fold}.txt"
...
plt.savefig(f"lambda-optimization-10folds-a-{a:.2f}.png", dpi=300)
plt.close()
