...
def build_state_matrix(train_file_list_path, val_file_list_path, a, u_dc, mu):
    ...
    alpha, f, omega_0, Q_0, tau, beta, gamma, R, kappa = 19.2, 22000.0, 138230.07675795088, 50.0, 0.001, 1066.0, 1.62e7, 16.5, 0.602e6
    u_max = 1.0
    h = 1e-6 * omega_0
    T = 50.0 * omega_0
...
if __name__ == '__main__':
    ...
    # Results dir
    results_dir = f"/scratch/almo2783/scratch/ml-paper/8587"
    ...
    # Save raw metrics
    np.savetxt(
        f"{results_dir}/results-a-{a:.2f}-mu-{mu:.2e}-f-22000.txt",
        outputs_arr,
        fmt="%.6f",
