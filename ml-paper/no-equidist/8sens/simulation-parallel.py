...
sensor_params = [
    ...
    (12.5, 1777, 2 * np.pi * 1777, 50, 0.001, 1066, 1.62e7, 12.5, 1e6, 0.5, 0.4),
    (12.5, 3555, 2 * np.pi * 3555, 50, 0.001, 1066, 1.62e7, 12.5, 1e6, 0.5, 0.4),
    (12.5, 5333, 2 * np.pi * 5333, 50, 0.001, 1066, 1.62e7, 12.5, 1e6, 0.5, 0.4),
    (12.5, 7111, 2 * np.pi * 7111, 50, 0.001, 1066, 1.62e7, 12.5, 1e6, 0.5, 0.4),
    (12.5, 8888, 2 * np.pi * 8888, 50, 0.001, 1066, 1.62e7, 12.5, 1e6, 0.5, 0.4),
    (12.5, 10666, 2 * np.pi * 10666, 50, 0.001, 1066, 1.62e7, 12.5, 1e6, 0.5, 0.4),
    (12.5, 12444, 2 * np.pi * 12444, 50, 0.001, 1066, 1.62e7, 12.5, 1e6, 0.5, 0.4),
    (12.5, 14222, 2 * np.pi * 14222, 50, 0.001, 1066, 1.62e7, 12.5, 1e6, 0.5, 0.4)
]
