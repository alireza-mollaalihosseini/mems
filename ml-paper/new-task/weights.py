...
if __name__ == "__main__":
    ...
    state_train = np.load(f"/scratch/almo2783/scratch/ml-paper/new-task/state-matrix/state_matrix_train-a-0.44-u_dc-0.4-mu-1.0.npz")
    ...
    state_test  = np.load(f"/scratch/almo2783/scratch/ml-paper/new-task/state-matrix/state_matrix_test-a-0.44-u_dc-0.4-mu-1.0.npz")
    ...
    # Save weights
    np.savez_compressed(f"/scratch/almo2783/scratch/ml-paper/new-task/weights/weights-a-{a_value}-lambda-{lambda_value}.npz", weights)