...
if __name__ == "__main__":
    ...
    X_train = np.load(f"/scratch/almo2783/scratch/ml-paper/spectral-mixer/state-matrix/state_matrix_train-a-0.44-u_dc-0.4-mu-1.0.npz")['state_matrix']
    X_val   = np.load(f"/scratch/almo2783/scratch/ml-paper/spectral-mixer/state-matrix/state_matrix_val-a-0.44-u_dc-0.4-mu-1.0.npz")['state_matrix']
    ...
    # Results dir
    results_dir = f"/scratch/almo2783/scratch/ml-paper/spectral-mixer/results"
    os.makedirs(results_dir, exist_ok=True)

    # Run in parallel
    Parallel(n_jobs=64, verbose=1, backend='threading')(  # adjust n_jobs depending on your cluster
