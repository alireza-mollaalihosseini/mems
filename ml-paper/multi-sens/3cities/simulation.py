...
if __name__ == '__main__':
    ...
    # Paths
    train_files = '/scratch/almo2783/scratch/rayson/design1/3cities/train-filenames-3cities-rayson.csv'
    val_files = '/scratch/almo2783/scratch/rayson/design1/3cities/val-filenames-3cities-rayson.csv'
    test_files = '/scratch/almo2783/scratch/rayson/design1/3cities/test-filenames-barcelona-rayson.csv'

    # Results dir
    results_dir = f"/scratch/almo2783/scratch/ml-paper/multi-sens/3cities/results"
    os.makedirs(results_dir, exist_ok=True)
