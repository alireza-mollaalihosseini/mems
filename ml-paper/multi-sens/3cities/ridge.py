...
if __name__ == '__main__':
    ...
    state_matrix = np.zeros((31670, len(f_values) * 60))
    ...
    lebels_test  = np.load(f"/scratch/almo2783/scratch/ml-paper/increased-dataset/3cities/labels_test.npy")
    ...
    # Results dir
    results_dir = f"/scratch/almo2783/scratch/ml-paper/multi-sens/3cities"
