...
scores = np.load("/scratch/almo2783/scratch/ml-paper/wavelet-packet/multi-sens/gini/feature_importances.npy")
idx = np.load("/scratch/almo2783/scratch/ml-paper/wavelet-packet/multi-sens/gini/feature_ranking_idx.npy")
