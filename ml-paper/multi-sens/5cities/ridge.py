...
if __name__ == '__main__':
    ...
    state_matrix = np.zeros((51070, len(f_values) * 60))
    
    for i, f in enumerate(f_values):
        cols = np.load(f"/scratch/almo2783/scratch/ml-paper/multi-sens/5cities/results/f-{int(f)}.npz")["arr_0"]
    ...
    lebels_test  = np.load(f"/scratch/almo2783/scratch/ml-paper/increased-dataset/5cities/labels_test.npy")
    ...
    # Results dir
    results_dir = f"/scratch/almo2783/scratch/ml-paper/multi-sens/5cities"
