...
if __name__ == '__main__':
    ...
    print("\n=== XGBoost on full 1-second features (hard labels) ===")

    xgb = XGBClassifier(
        n_estimators=1000,
        max_depth=8,              # moderate depth to control overfitting
        learning_rate=0.05,
        subsample=0.8,
    ...
    xgb.fit(X_train_full_std, hard_y_train)

    test_probs_xgb = xgb.predict_proba(X_test_full_std)
