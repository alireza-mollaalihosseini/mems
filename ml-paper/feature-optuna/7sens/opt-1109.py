...
if __name__ == "__main__":
    ...
    X_train = np.load(f"/scratch/almo2783/scratch/dim-less/8sensors/1109/state-matrix/state_matrix_train-a-0.06-u_dc-1.0-mu-1.0.npz")['arr_0']
    X_val   = np.load(f"/scratch/almo2783/scratch/dim-less/8sensors/1109/state-matrix/state_matrix_val-a-0.06-u_dc-1.0-mu-1.0.npz")['arr_0']
    ...
    # Load weights
    weights = np.load(f"/scratch/almo2783/scratch/dim-less/8sensors/1109/weights/weights-a-0.06-lambda-10000.0.npz")['arr_0']
    ...
    study = optuna.create_study(
        study_name="ridge_feature_selection_weights_1109",
        direction="maximize",
        storage=f"sqlite:///{results_dir}/optuna-weights-1109.db",
        load_if_exists=True
    )
    ...
    np.savetxt(f"{results_dir}/best_results_weights_1109.txt", 
               best_results.reshape(1, -1), fmt="%.5f")
    
    np.savetxt(f"{results_dir}/best_conf_matrix_weights_1109.txt", 
