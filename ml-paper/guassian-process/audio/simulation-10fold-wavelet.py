...
def gp_classification_fast(X_train, Y_train, X_eval, Y_eval, n_restarts=1, optimize=True):
    # -------------------------
    # Handle labels
    # -------------------------
    ...
    # -------------------------
    # Kernel definition (RBF + WhiteKernel + Constant for stability)
    # -------------------------
    ...
    gp = GaussianProcessClassifier(
        kernel=kernel if optimize else None,  # None = default RBF(1.0)
...
if __name__ == "__main__":
    ...
    for fold, (train_idx, test_idx) in enumerate(
        ...
        fold_outputs = gp_classification_fast(X_train_std, y_train, X_test_std, y_test)
