...
if __name__ == "__main__":
    ...
    X_train = np.load(f"/scratch/almo2783/scratch/ml-paper/time-domain/state-matrix/state_matrix_train-a-0.44-u_dc-0.4-mu-1.0.npz")['arr_0']
    X_val   = np.load(f"/scratch/almo2783/scratch/ml-paper/time-domain/state-matrix/state_matrix_val-a-0.44-u_dc-0.4-mu-1.0.npz")['arr_0']
    ...
    # Results dir
    results_dir = f"/scratch/almo2783/scratch/ml-paper/time-domain/results/lambda"
