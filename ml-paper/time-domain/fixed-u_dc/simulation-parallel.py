...
if __name__ == '__main__':
    ...
    for a in a_values:
        ...
        state_train = build_state_matrix(
                        train_files,
                        f'/scratch/almo2783/scratch/ml-paper/time-domain/state-matrix/state_matrix_train-a-{a}-u_dc-{u_dc}-mu-{mu}.npz',
                        a, u_dc, mu
                    )

        state_val = build_state_matrix(
                        val_files,
                        f'/scratch/almo2783/scratch/ml-paper/time-domain/state-matrix/state_matrix_val-a-{a}-u_dc-{u_dc}-mu-{mu}.npz',
                        a, u_dc, mu
                    )
        ...
        # Save
        np.savetxt(f"/scratch/almo2783/scratch/ml-paper/time-domain/fixed-u_dc/results/results_val-a-{a}-u_dc-{u_dc}-mu-{mu}-lam-{lam:.0e}.txt",
                results_val.reshape(1, -1), fmt="%.5f")
        np.savetxt(f"/scratch/almo2783/scratch/ml-paper/time-domain/fixed-u_dc/results/conf_matrix_val-a-{a}-u_dc-{u_dc}-mu-{mu}-lam-{lam:.0e}.txt",
                cm_val, fmt="%.5f")