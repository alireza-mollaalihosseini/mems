...
def process_file(fname, idxs, b_filt, a_filt, y_final, N_force, h, c1, c2, c3, c4, c5, phi_dc, a, new_fs):
...
def build_state_matrix(file_list_path, a, u_dc, mu, new_fs):
    ...
    results = Parallel(n_jobs=64, backend='threading')(
        delayed(process_file)(fname, idxs, b_filt, a_filt, y_final, N_force, h, c1, c2, c3, c4, c5, phi_dc, a, new_fs)
...
def simulate_sensor(a, u_dc, mu, new_fs):
    ...
    X_train_all = build_state_matrix(train_file_list_path, a, u_dc, mu, new_fs)
    X_val_all = build_state_matrix(val_file_list_path, a, u_dc, mu, new_fs)
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(
        direction="maximize",
        study_name="2600_timesample_optimization",
        storage="sqlite:///2600_time_opt.db",
        load_if_exists=True
    )
    ...
    # # After optimization
    # study.trials_dataframe().to_csv("2600_time_results.csv", index=False)
