...
if __name__ == '__main__':
    ...
    f_values_origin = np.array([43630, 44120, 42650, 45590,  6390, 44610, 23540, 45100,  6880,
    ...
    # top_picks = [8, 16, 32, 64]

    # for top_k in top_picks:
    print(f"Processing top {64} sensors...")
    f_values = np.sort(f_values_origin[:64])
    ...
    print(f"Train Accuracy: {best_train:.2f}%")
    print(f"Val Accuracy: {best_test:.2f}%")
