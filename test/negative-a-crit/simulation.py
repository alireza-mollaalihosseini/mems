...
if __name__ == '__main__':
    ...
    mu = 1.0
    ratios = np.array([0.1, 0.3, 0.5, 0.7, 0.9, 1.0, 1.1, 1.3])
    u_dc = args.u_dc
    ...
    np.save(f"/scratch/almo2783/scratch/test/negative-a-crit/a-crits/a-crit-u-dc-{u_dc:.1f}.npy", a_crits)
    ...
    np.save(f"/scratch/almo2783/scratch/test/negative-a-crit/lambdas/best_lambdas_u_dc-{u_dc:.1f}.npy", np.array(lambdas))
    np.save(f"/scratch/almo2783/scratch/test/negative-a-crit/training/training_acc_u_dc-{u_dc:.1f}.npy", np.array(train_accs))
    np.save(f"/scratch/almo2783/scratch/test/negative-a-crit/validation/validation_acc_u_dc-{u_dc:.1f}.npy", np.array(val_accs))