...
if __name__ == '__main__':
    ...
    np.save(f"/scratch/almo2783/scratch/test/sound-pressur/lambdas/best_lambdas_mu-{mu:.1e}-scaled.npy", np.array(lambdas))
    np.save(f"/scratch/almo2783/scratch/test/sound-pressur/training/training_acc_mu-{mu:.1e}-scaled.npy", np.array(train_accs))
    np.save(f"/scratch/almo2783/scratch/test/sound-pressur/validation/validation_acc_mu-{mu:.1e}-scaled.npy", np.array(val_accs))