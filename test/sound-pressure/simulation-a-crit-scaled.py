...
if __name__ == '__main__':
    ...
    np.save(f"/scratch/almo2783/scratch/test/sound-pressure/lambdas/best_lambdas-u_dc-{u_dc:.2f}-ratio-{ratio:.1f}-a-crits-scaled.npy", np.array(lambdas))
    np.save(f"/scratch/almo2783/scratch/test/sound-pressure/training/training_acc-u_dc-{u_dc:.2f}-ratio-{ratio:.1f}-a-crits-scaled.npy", np.array(train_accs))
    np.save(f"/scratch/almo2783/scratch/test/sound-pressure/validation/validation_acc-u_dc-{u_dc:.2f}-ratio-{ratio:.1f}-a-crits-scaled.npy", np.array(val_accs))
