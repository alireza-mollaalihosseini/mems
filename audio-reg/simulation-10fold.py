...
if __name__ == "__main__":
    ...
    # Results dir
    results_dir = f"/scratch/almo2783/scratch/audio-reg/results-log"
    ...
    for fold, (train_idx, test_idx) in enumerate(
        ...
        # -----------------------------
        for i, (metrics, conf) in enumerate(fold_outputs):
            ...
            np.savetxt(
                f"{results_dir}/fold_conf_matrix-lambda-{lam:.1e}-fold-{fold}.txt",
                conf,
                fmt="%d"
            )
