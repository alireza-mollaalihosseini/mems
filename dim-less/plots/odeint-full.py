...
t_rec = 10.0                   # Recording time (seconds)
noise = 1e-3                  # Noise magnitude
u_max = 1.0
...
# Load the results
results_up = np.load(f'/scratch/almo2783/scratch/dim-less/deflections-up-t-sim-{T}-t-rec-{t_rec}-noise-{noise:.0e}-u_max-{u_max}.npy')
results_down = np.load(f'/scratch/almo2783/scratch/dim-less/deflections-down-t-sim-{T}-t-rec-{t_rec}-noise-{noise:.0e}-u_max-{u_max}.npy')
