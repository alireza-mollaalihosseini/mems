...
np.save(
    f'/scratch/almo2783/scratch/dim-less/grid-search/design1/deflections-down/deflections-RK4-down-t-sim-{int(T / omega_0)}-t-rec-{int(t_rec / omega_0)}-noise-{noise:.0e}-u_max-{u_max}-u_dc-{u_dc}.npy',
    # f'/scratch/almo2783/scratch/dim-less/grid-search/design1/deflections-down/voltages-RK4-down-t-sim-{int(T / omega_0)}-t-rec-{int(t_rec / omega_0)}-noise-{noise:.0e}-u_max-{u_max}.npy',
    results
)