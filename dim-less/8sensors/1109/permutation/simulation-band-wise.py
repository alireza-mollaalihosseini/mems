...
X      = np.load('/scratch/almo2783/scratch/dim-less/8sensors/1109/state-matrix/state_matrix_train-a-0.06-u_dc-1.0-mu-1.0.npz')['arr_0']
X_val  = np.load('/scratch/almo2783/scratch/dim-less/8sensors/1109/state-matrix/state_matrix_val-a-0.06-u_dc-1.0-mu-1.0.npz')['arr_0']
...
weights = np.load('/scratch/almo2783/scratch/dim-less/8sensors/1109/weights/weights-a-0.06-lambda-10000.0.npz')['arr_0']
