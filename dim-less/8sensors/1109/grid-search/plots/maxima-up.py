...
def process_u_dc(j, u_dc, a_values, const_tol, T, t_rec, u_max):
    results_up = np.load(
        f'/scratch/almo2783/scratch/dim-less/8sensors/1109/grid-search/deflections-up/'
...
# save extrema_counts
np.save('extrema_count_1109.npy', extrema_counts)
np.save('crossings_1109.npy', crossings)
np.save('a_crits_1109.npy', a_crits)
