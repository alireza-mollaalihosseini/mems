...
if __name__ == "__main__":
    ...
    state_train = np.load(f"/scratch/almo2783/scratch/dim-less/8sensors/2600/state-matrix/state_matrix_train-a-{a_value}-u_dc-{u_dc_value}-mu-{mu}.npz")
    # state_val   = np.load(f"/scratch/almo2783/scratch/dim-less/8sensors/2600/state-matrix/state_matrix_val-a-{a_value}-u_dc-{u_dc_value}-mu-{mu}.npz")
    state_test  = np.load(f"/scratch/almo2783/scratch/dim-less/8sensors/2600/state-matrix/state_matrix_test-a-{a_value}-u_dc-{u_dc_value}-mu-{mu}.npz")
    ...
    # Save weights
    np.savez_compressed(f"/scratch/almo2783/scratch/dim-less/8sensors/2600/weights/weights-a-{a_value}-lambda-{lambda_value}.npz", weights)