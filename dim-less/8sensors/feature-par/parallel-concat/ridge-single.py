...
def process_lambda(lam, X_train, labels_train, X_test, labels_test, X_val, labels_val, results_dir):
    ...
    # Save results
    np.savetxt(f"{results_dir}/results_test-lam-{lam:.0e}-7.txt",
               results_test.reshape(1, -1), fmt="%.5f")
    np.savetxt(f"{results_dir}/conf_matrix_test-lam-{lam:.0e}-7.txt",
               cm_test, fmt="%.5f")

    np.savetxt(f"{results_dir}/results_val-lam-{lam:.0e}-7.txt",
               results_val.reshape(1, -1), fmt="%.5f")
    np.savetxt(f"{results_dir}/conf_matrix_val-lam-{lam:.0e}-7.txt",
               cm_val, fmt="%.5f")
...
if __name__ == "__main__":
    ...
    results_dir = "/scratch/almo2783/scratch/dim-less/8sensors/feature-par/results"
    ...
    # X_train = np.concatenate([X_train1, X_train7])
    # X_val   = np.concatenate([X_val1, X_val7])
    # X_test  = np.concatenate([X_test1, X_test7])

    # Standardize
    scaler  = StandardScaler()
    X_train = scaler.fit_transform(X_train7)
    X_val   = scaler.transform(X_val7)
    X_test  = scaler.transform(X_test7)

    # labels
    labels_train1 = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_train.npy")
    labels_test1  = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_test.npy")
    labels_val1   = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_val.npy")

    # labels_train2 = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_train.npy")
    # labels_test2  = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_test.npy")
    # labels_val2   = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_val.npy")

    # labels_train3 = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_train.npy")
    # labels_test3  = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_test.npy")
    # labels_val3   = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_val.npy")

    # labels_train4 = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_train.npy")
    # labels_test4  = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_test.npy")
    # labels_val4   = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_val.npy")

    # labels_train5 = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_train.npy")
    # labels_test5  = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_test.npy")
    # labels_val5   = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_val.npy")

    # labels_train6 = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_train.npy")
    # labels_test6  = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_test.npy")
    # labels_val6   = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_val.npy")

    # labels_train7 = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_train.npy")
    # labels_test7  = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_test.npy")
    # labels_val7   = np.load("/scratch/almo2783/scratch/dim-less/barcelona/label_matrix_val.npy")

    # # concatenate the labels
    # labels_train = np.concatenate([labels_train1, labels_train7])
    # labels_test  = np.concatenate([labels_test1, labels_test7])
    # labels_val   = np.concatenate([labels_val1, labels_val7])
    ...
    processed = Parallel(n_jobs=-1, verbose=10)(
        delayed(process_lambda)(
            lam, X_train_selected, labels_train1, X_test_selected, labels_test1,
            X_val_selected, labels_val1, results_dir
        )
