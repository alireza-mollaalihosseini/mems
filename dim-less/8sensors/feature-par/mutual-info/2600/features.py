...
def compute_feature_ranking(X, y):
    ...
    scores = mutual_info_classif(X, y_labels, random_state=42)
...
if __name__ == "__main__":
    ...
    # Results dir
    results_dir = f"/scratch/almo2783/scratch/dim-less/8sensors/feature-par/mutual-info/2600/results"
    os.makedirs(results_dir, exist_ok=True)

    # Compute MI scores once
    ranked_idx, mi_scores = compute_feature_ranking(X_train, labels_train)
