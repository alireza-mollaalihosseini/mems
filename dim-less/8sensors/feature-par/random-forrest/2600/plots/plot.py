...
for top_k in top_k_values:
    try:
        data = np.loadtxt(f"/scratch/almo2783/scratch/dim-less/8sensors/feature-par/random-forrest/2600/results/results-a-{a_value:.2f}-u_dc-{u_dc_value:.2f}-topk-{top_k}-lambda-{lambda_value}-gini.txt")
