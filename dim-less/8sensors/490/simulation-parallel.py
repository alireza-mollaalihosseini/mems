...
if __name__ == '__main__':
    ...
    build_state_matrix(
        train_files,
        f'/scratch/almo2783/scratch/dim-less/8sensors/490/state-matrix/state_matrix_train-a-{a}-u_dc-{u_dc}-mu-{mu}.npz',
        a, u_dc, mu
    )

    build_state_matrix(
        val_files,
        f'/scratch/almo2783/scratch/dim-less/8sensors/490/state-matrix/state_matrix_val-a-{a}-u_dc-{u_dc}-mu-{mu}.npz',
        a, u_dc, mu
    )

    build_state_matrix(
        test_files,
        f'/scratch/almo2783/scratch/dim-less/8sensors/490/state-matrix/state_matrix_test-a-{a}-u_dc-{u_dc}-mu-{mu}.npz',
        a, u_dc, mu
    )