...
crossings = np.array([1.64444034, 0.82223149, 0.54815846, 0.41112597, 0.32893591,
                      0.27412869, 0.23493633, 0.20563413, 0.18273372, 0.16450785])
# Preallocate
...
def process_u_dc(j, u_dc, a_values, const_tol, T, t_rec, u_max):
    results_up = np.load(
        f'/scratch/almo2783/scratch/dim-less/8sensors/582/grid-search/deflections-up/'
...
# save extrema_counts
np.save('extrema_count_582.npy', extrema_counts)
np.save('crossings_582.npy', crossings)
np.save('a_crits_582.npy', a_crits)
