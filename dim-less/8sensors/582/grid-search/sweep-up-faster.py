...
np.save(
    f'/scratch/almo2783/scratch/dim-less/8sensors/582/grid-search/deflections-up/deflections-RK4-up-t-sim-{int(T / omega_0)}-t-rec-{int(t_rec / omega_0)}-noise-{noise:.0e}-u_max-{u_max}-u_dc-{u_dc}.npy',
    results
)