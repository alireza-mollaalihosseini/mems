...
np.save(
    # f'deflections-RK4-up-t-sim-{int(T / omega_0)}-t-rec-{int(t_rec / omega_0)}-noise-{noise:.0e}-u_max-{u_max}.npy',
    f'voltages-RK4-up-t-sim-{int(T / omega_0)}-t-rec-{int(t_rec / omega_0)}-noise-{noise:.0e}-u_max-{u_max}.npy',
    results
)