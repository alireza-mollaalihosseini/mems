...
plt.scatter(a_values, max_peaks[::-1], label="Global max peak")
plt.scatter(a_values, min_peaks[::-1], label="Global min peak")
...
plt.legend()
plt.grid(True)
# plt.savefig(f'bifurcation-{direction}-tau-kick-{kick}.png')
# plt.savefig(f'bifurcation-{direction}-tau-kick-{kick}-negative.png')
plt.savefig(f'bifurcation-{direction}-tau-kick-{kick}-positive.png')
plt.close()