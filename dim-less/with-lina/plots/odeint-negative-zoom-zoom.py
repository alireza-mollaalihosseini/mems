...
a_full = np.concatenate([a1, a2, extra1, extra3, a3, a4, extra2, a5])
...
mask = (a_full > -1.8761) & (a_full < -1.87605)  # zoom zoom negative 1

# Cropped a_values
a_values = a_full[mask]           # shape (N,)

# -------------------- Load full results --------------------
# results_up_full = np.load(f'/scratch/almo2783/scratch/dim-less/with-lina/deflections-RK4-up-t-sim-500-t-rec-3-noise-2e-03-u_max-1.0.npy')
# results_down_full = np.load(f'/scratch/almo2783/scratch/dim-less/with-lina/deflections-RK4-down-t-sim-500-t-rec-3-noise-2e-03-u_max-1.0.npy')
# results_up_full = np.load(f'/scratch/almo2783/scratch/dim-less/with-lina/deflections-RK4-up-t-sim-5000-t-rec-3-noise-2e-03-u_max-1.0.npy')
# results_down_full = np.load(f'/scratch/almo2783/scratch/dim-less/with-lina/deflections-RK4-down-t-sim-5000-t-rec-3-noise-2e-03-u_max-1.0.npy')
# results_up_full = np.load(f'/scratch/almo2783/scratch/dim-less/with-lina/deflections-RK4-up-t-sim-500-t-rec-3-noise-2e-04-u_max-1.0.npy')
# results_down_full = np.load(f'/scratch/almo2783/scratch/dim-less/with-lina/deflections-RK4-down-t-sim-500-t-rec-3-noise-2e-04-u_max-1.0.npy')
results_up_full = np.load(f'/scratch/almo2783/scratch/dim-less/with-lina/voltages-RK4-up-t-sim-500-t-rec-3-noise-2e-04-u_max-1.0.npy')
results_down_full = np.load(f'/scratch/almo2783/scratch/dim-less/with-lina/voltages-RK4-down-t-sim-500-t-rec-3-noise-2e-04-u_max-1.0.npy')
...
outname = f'extrema-RK4-sweeps-voltages-t-sim-{T}-t-rec-{t_rec}-noise-{noise:.0e}-u_max-{u_max}-negative-zoom-zoom-1.png'
