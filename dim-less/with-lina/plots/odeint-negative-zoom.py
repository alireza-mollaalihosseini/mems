...
# -------------------- Load full results --------------------
results_down_full = np.load(f'/scratch/almo2783/scratch/sweeps-test/python/deflections-down-t-sim-{T}-t-rec-{t_rec}-noise-{noise:.0e}-u_max-{u_max}-more-200.npy')

try:
    # Load the results
    results_up_full = np.load(f'/scratch/almo2783/scratch/sweeps-test/python/deflections-up-t-sim-{T}-t-rec-{t_rec}-noise-{noise:.0e}-u_max-{u_max}-more-200.npy')
...
outname = f'extrema-odeint-sweeps-t-sim-{T}-t-rec-{t_rec}-noise-{noise:.0e}-u_max-{u_max}-more-200-negative-zoom.png'
